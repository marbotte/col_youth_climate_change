...
data2 <- data1 %>%
  select(Zona, sex, age_r, estrato, etnia, education, edu, kids, ideology, Internet, trust_vote_inst, eco_anx, eco_anx2, cir_mod, imp_sci, imp_ac, imp_re, imp_po, thoughts, dis_act, clim_origin, cont_clim, C36_1, C36_2, C36_3, C36_4, C36_5, C36_6, C36_7, C36_8, C36_9, C36_10, C36_11, C36_12, C36_13, C36_14, C36_15, C36_16)
...
```{r disposicion a actuar y eco ansiedad, fig.align='center', echo=F}
...
plot_aso_eco_anx <- data2 %>%
  ...
  geom_bar(position = "fill") +
  labs(x = "Disposición a actuar frente al cambio climático", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  scale_fill_manual(values = custom_palette)
plot_aso_eco_anx
```
...
tab_ori_dis <- table(data2$clim_origin, data2$dis_act)
...
plot_ori_dis <- data2 %>%
  ...
  geom_bar(position = "fill") +
  labs(x = "Disposición a actuar frente al cambio climático", y = "Proporción", fill = "Origen Cambio Climático") +
  papaja::theme_apa() +
  scale_fill_manual(values = custom_palette)
plot_ori_dis
```
...
tab_ori_int <- table(data2$clim_origin, data2$Internet)
...
plot_ori_int <- data2 %>%
  ...
  geom_bar(position = "fill") +
  labs(x = "Origen Cambio Climático", y = "Proporción", fill = "Internet como \nfuente de información") +
  papaja::theme_apa() +
  scale_fill_manual(values = custom_palette)
plot_ori_int
```
