...
data2 <- data1 %>%
  select(Zona, sex, age_r, estrato, etnia, education, kids, ideology, Televisión, Radio, Prensa_Impresa, Medios_Digitales, Redes_Sociales, med, trust_vote_inst, eco_anx, env_aso, imp_scien, imp_act, imp_rel, imp_pol, thoughts, imp_como, imp_cli, no_car, one_fw_ch, veg, only_bk_wk, clim_origin, cont_clim)

data3 <- data1 %>%
  select(Zona, sex, age_r, strat, ethni, edu, kids, ideology, med, trust_vote_inst, eco_anx, env_aso, imp_sci, imp_ac, imp_re, imp_po, thoughts, imp_com, imp_cl, clim_origin, cont_clim)
# Not included: Negative emotions towards government actions against climate change, Alternative media

codigo <- c("Zona", "sex", "age_r", "strat", "ethni", "edu", "kids", "ideology", "med", "trust_vote_inst", "eco_anx", "env_aso", "imp_sci", "imp_ac", "imp_re", "imp_po", "thoughts", "imp_com", "imp_cli", "clim_origin", "cont_clim")
descripcion <- c("Zona de residencia", "Sexo", "Rango de edad", "Estrato socioeconómico", "Pertenece a alguna etnia", "Tiene estudios de educación superior", "Tiene hijos", "Ideología política", "Tipo de medios de información utilizado", "Confía en las instituciones con cargos de elección popular", "Emociones frente al cambio climático", "Se uniría a una organización ambiental", "Impacto de los científicos frente al cambio climático", "Impacto de activistas frente al cambio climático", "Impacto de grupos religiosos frente al cambio climático", "Impacto de políticos frente al cambio climático", "Pensamientos frente al cambio climático", "Impacto de acciones individuales en su comodidad", "Impacto de acciones individuales en el cambio climático", "Causa u origen del cambio climático", "Factor que más contribuye al cambio climático")
