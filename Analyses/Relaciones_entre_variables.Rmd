...
data2 <- data1 %>%
  dplyr::select(Zona, sex, age_r, strat, ethni, edu, kids, ideology, Internet, trust_vote_inst, eco_anx, imp_sci, imp_ac, imp_re, imp_po, thoughts, clim_origin, cont_clim, aso, neg_emo_gov, imp_como)
# Not included: Negative emotions towards government actions against climate change, Alternative media

codigo <- c("Zona", "sex", "age_r", "strat", "ethni", "edu", "kids", "ideology", "Internet", "trust_vote_inst", "eco_anx", "imp_sci", "imp_ac", "imp_re", "imp_po", "thoughts", "clim_origin", "cont_clim", "aso", "neg_emo_gov", "imp_como")
descripcion <- c("Zona de residencia", "Sexo", "Rango de edad", "Estrato socioeconómico", "Pertenece a alguna etnia", "Tiene estudios de educación superior", "Tiene hijos", "Ideología política", "Se informa a través de internet", "Confía en las instituciones con cargos de elección popular", "Emociones frente al cambio climático", "Impacto de los científicos frente al cambio climático", "Impacto de activistas frente al cambio climático", "Impacto de grupos religiosos frente al cambio climático", "Impacto de políticos frente al cambio climático", "Pensamientos frente al cambio climático", "Causa u origen del cambio climático", "Factor que más contribuye al cambio climático", "Unirse a una organización ambiental", "Emociones negativas gobierno cambio climático", "Impacto en comodidad")
...
fviz(res.mca, element = "ind", geom = "point", pointsize = 2, hab = "imp_como", alpha = 0.2)
...
res.mca <- MCA(data2, quali.sup = c(1:7), graph = FALSE)
fviz_eig(res.mca, addlabels = TRUE, title = "Inertia of MCA Dimensions")
fviz_mca_ind(res.mca, geom = "point", pointsize = 2, repel = TRUE)
#fviz_mca_biplot(res.mca, geom.ind = "point", repel = TRUE, alpha.ind = 0.1)
fviz_mca_var(res.mca, choice = "var.cat", repel = TRUE)
...
```{r relación unirse a una organización y emociones, fig.align='center', echo=F}
tab_aso_eco_anx <- table(data2$aso, data2$eco_anx)
kable(round(prop.table(tab_aso_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_aso_eco_anx <- data2 %>%
  ggplot(aes(x = aso, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Unirse a una organización ambiental", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_aso_eco_anx
...
```{r emociones gobierno y emociones, fig.align='center', echo=F}
tab_neg_eco_anx <- table(data2$neg_emo_gov, data2$eco_anx)
kable(round(prop.table(tab_neg_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_neg_eco_anx <- data2 %>%
  ggplot(aes(x = neg_emo_gov, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Emociones ante acciones gobierno \nfrente a cambio climático", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_neg_eco_anx
...
```{r impacto comodidad y emociones, fig.align='center', echo=F}
tab_como_eco <- table(data2$imp_como, data2$eco_anx)
kable(round(prop.table(tab_como_eco) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_como_eco <- data2 %>%
  ggplot(aes(x = imp_como, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Impacto en comodidad", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_como_eco
...
tab_ori_edu <- table(data2$edu, data2$clim_origin)
kable(round(prop.table(tab_ori_edu) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_ori_edu <- data2 %>%
  ggplot(aes(x = edu, fill = clim_origin)) +
  geom_bar(position = "fill") +
...
tab_ori_sci <- table(data2$imp_sci, data2$clim_origin)
...
```{r relación unirse a una organización y origen cambio climático, fig.align='center', echo=F}
tab_aso_ori <- table(data2$aso, data2$clim_origin)
kable(round(prop.table(tab_aso_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_aso_ori <- data2 %>%
  ggplot(aes(x = aso, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Unirse a una organización ambiental", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_aso_ori
...
```{r emociones gobierno y origen cambio climático, fig.align='center', echo=F}
tab_neg_ori <- table(data2$neg_emo_gov, data2$clim_origin)
kable(round(prop.table(tab_neg_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_neg_ori <- data2 %>%
  ggplot(aes(x = neg_emo_gov, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Emociones ante acciones gobierno \nfrente a cambio climático", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_neg_ori
...
```{r impacto comodidad y origen cambio climático, fig.align='center', echo=F}
tab_como_ori <- table(data2$imp_como, data2$clim_origin)
kable(round(prop.table(tab_como_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_como_ori <- data2 %>%
  ggplot(aes(x = imp_como, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Impacto en comodidad", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_como_ori
...
sig_var <- c("Edad", "Estrato", "Etnia", "Ideología", "Internet", "Confianza Instituciones", "Emociones cambio climático", "Impacto científicos", "Impacto activistas", "Impacto grupos religiosos", "Impacto políticos", "Pensamientos cambio climático", "Contribución cambio climático", "Unirse a una organización ambiental", "Emociones negativas hacia gobierno por cambio climático", "Impacto en comodidad")
...
# Print the names of the significant variables
sig_var <- c("Educación", "Ideología", "Internet", "Confianza Instituciones", "Impacto grupos religiosos", "Impacto políticos", "Pensamientos cambio climático", "Origen cambio climático", "Contribución cambio climático", "Unirse a una organización ambiental", "Emociones negativas hacia gobierno por cambio climático", "Impacto en comodidad")
# Print the significant p-values
...
specific_variable <- "clim_origin"
variables_to_include <- c("age_r","strat", "ethni", "ideology", "Internet", "trust_vote_inst", "eco_anx", "imp_sci", "imp_ac", "imp_re", "imp_po", "thoughts", "cont_clim", "aso", "neg_emo_gov", "imp_como")
...
specific_variable <- "eco_anx"
variables_to_include <- c("edu","ideology", "Internet", "trust_vote_inst", "imp_re", "imp_po", "thoughts", "clim_origin", "cont_clim", "aso", "neg_emo_gov", "imp_como")
...
data2 <- data1 %>%
  dplyr::select(Zona, sex, age_r, strat, ethni, edu, kids, ideology, Internet, trust_vote_inst, cir_mod2, imp_sci, imp_ac, imp_re, imp_po, thoughts, clim_origin, cont_clim, aso, neg_emo_gov, imp_como)
# Not included: Negative emotions towards government actions against climate change, Alternative media

codigo <- c("Zona", "sex", "age_r", "strat", "ethni", "edu", "kids", "ideology", "Internet", "trust_vote_inst", "cir_mod2", "imp_sci", "imp_ac", "imp_re", "imp_po", "thoughts", "clim_origin", "cont_clim", "aso", "neg_emo_gov", "imp_como")
descripcion <- c("Zona de residencia", "Sexo", "Rango de edad", "Estrato socioeconómico", "Pertenece a alguna etnia", "Tiene estudios de educación superior", "Tiene hijos", "Ideología política", "Se informa a través de internet", "Confía en las instituciones con cargos de elección popular", "Emociones frente al cambio climático", "Impacto de los científicos frente al cambio climático", "Impacto de activistas frente al cambio climático", "Impacto de grupos religiosos frente al cambio climático", "Impacto de políticos frente al cambio climático", "Pensamientos frente al cambio climático", "Causa u origen del cambio climático", "Factor que más contribuye al cambio climático", "Unirse a una organización ambiental", "Emociones negativas gobierno cambio climático", "Impacto en comodidad de acciones contra cambio climático")
table_vars <- data.frame(codigo, descripcion)
kable(table_vars, col.names = c("Código de la variable", "Descripción de la variable"), booktabs = TRUE)
...
fviz_mca_var(res.mca, choice = "var", repel = TRUE)
#summary(res.mca, ncp = 2, nbelements = Inf)
fviz(res.mca, element = "ind", geom = "point", pointsize = 2, hab = "cir_mod2", alpha = 0.2)
fviz(res.mca, element = "ind", geom = "point", pointsize = 2, hab = "clim_origin", alpha = 0.2)
fviz(res.mca, element = "ind", geom = "point", pointsize = 2, hab = "Internet", alpha = 0.2)
dimdesc(res.mca, axes = 1:2)
```
...
tab_ori_eco_anx <- table(data2$clim_origin, data2$cir_mod2)
kable(round(prop.table(tab_ori_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_ori_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = clim_origin)) +
  geom_bar(position = "fill") +
...
tab_th_eco_anx <- table(data2$thoughts, data2$cir_mod2)
kable(round(prop.table(tab_th_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_th_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = thoughts)) +
  geom_bar(position = "fill") +
...
tab_ide_eco_anx <- table(data2$ideology, data2$cir_mod2)
kable(round(prop.table(tab_ide_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_ide_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = ideology)) +
  geom_bar(position = "fill") +
...
tab_como_eco_anx <- table(data2$imp_como, data2$cir_mod2)
kable(round(prop.table(tab_como_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_como_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = imp_como)) +
  geom_bar(position = "fill") +
  labs(x = "Emociones frente al \ncambio climático", y = "Proporción", fill = "Impacto en comodidad") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_como_eco_anx
...
tab_cont_eco_anx <- table(data2$cont_clim, data2$cir_mod2)
kable(round(prop.table(tab_cont_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_cont_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = cont_clim)) +
  geom_bar(position = "fill") +
...
tab_int_eco_anx <- table(data2$Internet, data2$cir_mod2)
kable(round(prop.table(tab_int_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_int_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = Internet)) +
  geom_bar(position = "fill") +
...
tab_tru_eco_anx <- table(data2$trust_vote_inst, data2$cir_mod2)
kable(round(prop.table(tab_tru_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_tru_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = trust_vote_inst)) +
  geom_bar(position = "fill") +
...
tab_zona_eco_anx <- table(data2$Zona, data2$cir_mod2)
kable(round(prop.table(tab_zona_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_zona_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = Zona)) +
  geom_bar(position = "fill") +
...
tab_age_eco_anx <- table(data2$age_r, data2$cir_mod2)
kable(round(prop.table(tab_age_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_age_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = age_r)) +
  geom_bar(position = "fill") +
...
```{r relación unirse a una organización y emociones 2, fig.align='center', echo=F}
tab_aso_eco_anx <- table(data2$aso, data2$cir_mod2)
kable(round(prop.table(tab_aso_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_aso_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = aso)) +
  geom_bar(position = "fill") +
  labs(x = "Emociones frente al \ncambio climático", y = "Proporción", fill = "Unirse a una organización ambiental") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_aso_eco_anx
...
```{r emociones gobierno y emociones 2, fig.align='center', echo=F}
tab_neg_eco_anx <- table(data2$neg_emo_gov, data2$cir_mod2)
kable(round(prop.table(tab_neg_eco_anx) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_neg_eco_anx <- data2 %>%
  ggplot(aes(x = cir_mod2, fill = neg_emo_gov)) +
  geom_bar(position = "fill") +
  labs(x = "Emociones frente al \ncambio climático", y = "Proporción", fill = "Emociones ante acciones gobierno \nfrente a cambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_neg_eco_anx
...
# Print the names of the significant variables
sig_var <- c("Ideología", "Confianza Instituciones", "Impacto grupos religiosos", "Impacto políticos", "Pensamientos cambio climático", "Origen cambio climático", "Unirse a una organización ambiental", "Emociones negativas hacia gobierno por cambio climático", "Impacto en comodidad")
# Print the significant p-values
...
specific_variable <- "clim_origin"
variables_to_include <- c("age_r","strat", "ethni", "ideology", "Internet", "trust_vote_inst", "cir_mod2", "imp_sci", "imp_ac", "imp_re", "imp_po", "thoughts", "cont_clim", "aso", "neg_emo_gov", "imp_como")
...
specific_variable <- "cir_mod2"
variables_to_include <- c("ideology", "trust_vote_inst", "imp_re", "imp_po", "thoughts", "clim_origin", "aso", "neg_emo_gov", "imp_como")
...
```{r disposicion no carro y emociones, fig.align='center', echo=F, eval=FALSE}
tab_no_car_eco <- table(data2$no_car_1, data2$eco_anx)
kable(round(prop.table(tab_no_car_eco) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_no_car_eco <- data2 %>%
  ggplot(aes(x = no_car_1, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a no tener carro", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_no_car_eco
...
```{r disposicion un hijo menos y emociones, fig.align='center', echo=F, eval=FALSE}
tab_fw_ch_eco <- table(data2$one_fw_ch_1, data2$eco_anx)
kable(round(prop.table(tab_fw_ch_eco) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_fw_ch_eco <- data2 %>%
  ggplot(aes(x = one_fw_ch_1, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a tener un hijo menos", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_fw_ch_eco
...
```{r disposicion ser vegano o vegetariano y emociones, fig.align='center', echo=F, eval=FALSE}
tab_veg_eco <- table(data2$veg_1, data2$eco_anx)
kable(round(prop.table(tab_veg_eco) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_veg_eco <- data2 %>%
  ggplot(aes(x = veg_1, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a ser vegano o vegetariano", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_veg_eco
...
```{r disposicion usar solo bici o caminar y emociones, fig.align='center', echo=F, eval=FALSE}
tab_bk_wk_eco <- table(data2$only_bk_wk_1, data2$eco_anx)
kable(round(prop.table(tab_bk_wk_eco) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_bk_wk_eco <- data2 %>%
  ggplot(aes(x = only_bk_wk_1, fill = eco_anx)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a solo usar bici o caminar", y = "Proporción", fill = "Emociones frente al \ncambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_bk_wk_eco
...
```{r disposicion no carro y origen, fig.align='center', echo=F, eval=FALSE}
tab_no_car_ori <- table(data2$no_car_1, data2$clim_origin)
kable(round(prop.table(tab_no_car_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_no_car_ori <- data2 %>%
  ggplot(aes(x = no_car_1, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a no tener carro", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_no_car_ori
...
```{r disposicion un hijo menos y origen, fig.align='center', echo=F, eval=FALSE}
tab_fw_ch_ori <- table(data2$one_fw_ch_1, data2$clim_origin)
kable(round(prop.table(tab_fw_ch_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_fw_ch_ori <- data2 %>%
  ggplot(aes(x = one_fw_ch_1, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a tener un hijo menos", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_fw_ch_ori
...
```{r disposicion ser vegano o vegetariano y origen, fig.align='center', echo=F, eval=FALSE}
tab_veg_ori <- table(data2$veg_1, data2$clim_origin)
kable(round(prop.table(tab_veg_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_veg_ori <- data2 %>%
  ggplot(aes(x = veg_1, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a ser vegano o vegetariano", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_veg_ori
...
```{r disposicion usar solo bici o caminar y origen, fig.align='center', echo=F, eval=FALSE}
tab_bk_wk_ori <- table(data2$only_bk_wk_1, data2$clim_origin)
kable(round(prop.table(tab_bk_wk_ori) * 100, 1), booktabs = TRUE)

custom_palette <- brewer.pal(6, "BrBG")
plot_bk_wk_ori <- data2 %>%
  ggplot(aes(x = only_bk_wk_1, fill = clim_origin)) +
  geom_bar(position = "fill") +
  labs(x = "Disposición a solo usar bici o caminar", y = "Proporción", fill = "Origen humano del \nCambio climático") +
  papaja::theme_apa() +
  coord_flip() +
  scale_fill_manual(values = custom_palette)
plot_bk_wk_ori
