...
data2 <- data1 %>%
  select(eco_anx, Zona, sex, age_r, strat, ethni, A6, edu, kids, ideology, Televisión, Radio, Prensa_Impresa, Medios_Digitales, Redes_Sociales, Otro_medio, trust_vote_inst, trust_unis, env_aso, imp_scien, imp_act, imp_rel, imp_pol, thoughts, imp_como, imp_cli, clim_origin, cont_clim)
```
...
res.mca <- MCA(data2, method = "burt")
summary(res.mca, ncp = 3, nbelements = Inf)
dimdesc(res.mca)
plot(res.mca, invisible = "ind", autoLab = "y", cex = 0.7)
plot(res.mca, invisible = "ind", autoLab = "y", cex = 0.7, selectMod = "contrib 30")

res.mca <- MCA(data2, method = "burt", quali.sup = c(1, 24))
summary(res.mca, ncp = 3, nbelements = Inf)
dimdesc(res.mca)
plot(res.mca, invisible = "ind", autoLab = "y", cex = 0.8)
plot(res.mca, invisible = "ind", autoLab = "y", cex = 0.8, selectMod = "contrib 20")
plot(res.mca, invisible = c("ind", "var"), autoLab = "y", cex = 0.8)
plot(res.mca, invisible = c("var", "quali.sup"), autoLab = "y", cex = 0.8, habillage = "eco_anx")
```
