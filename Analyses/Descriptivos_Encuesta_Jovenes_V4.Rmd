...
El conjunto de 16 emociones fue agrupado en tres niveles: Emociones de alta activación, Emociones de baja activación y emociones ambivalentes o neutras.
...
```{r variable emo recodificada 2, fig.align='center', echo=FALSE}
...
```{r recodificación emociones cambio climático 4, include=FALSE, eval=FALSE}
unp_deac <- c("C36_1", "C36_10", "C36_11", "C36_15")
unp_act <- c("C36_3", "C36_4", "C36_5", "C36_6", "C36_7", "C36_8", "C36_9")
...
```{r recodificación etnia, include=FALSE, eval=FALSE}
...
```{r variable etnia recodificada, fig.align='center', include=FALSE, eval=FALSE}
...
```{r recodificación medios, include=FALSE}
...
Los distintos medios de información fueron agrupados para crear una variable que distingue si la persona se informa con medios exclusivamente validados, medios exclusivamente no validados, o ambos tipos de medios.
```{r variable recodificacion medios, fig.align='center', echo=F}
