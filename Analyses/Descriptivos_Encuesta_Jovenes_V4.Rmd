...
```{r variable emo recodificada 3, fig.align='center', include=FALSE, eval=FALSE}
...
Las instituciones donde se los cargos ocupados son de elección popular se agruparon para conformar una nueva variable.
...
```{r variable medida de confianza, warning=FALSE, fig.align='center', include=FALSE, eval=FALSE}
